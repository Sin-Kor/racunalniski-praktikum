...
% začetek okolja enumerate
   ...
   \item Iz sistema okolic izberemo okolico. To storimo tako, da naključno izberemo
   eno izmed operacij sistema okolic (vstavljanje, brisanje ali zamenjava) in nato
   iz nje ustvarimo okolico.
   \item Iz izbrane okolice naključno izberemo eno izmed sprememb.
   \item Izvedemo izbrano spremembo na trenutnem urniku.
\end{enumerate}
